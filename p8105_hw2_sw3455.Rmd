...
mean(pull(viewers_df |> filter(series == 5), 
     ...
     na.rm = TRUE)
```
I use read_csv() to import the viewer.csv and clean the name by janitor package. I pivot it longer to make episode andseries both are column,  so we have all value in same column.
